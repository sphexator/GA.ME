...
{
    [Get("/cards/search")]
    Task<CardsResponse> Search (string name);
}
...
public sealed class Card
{
    ...
    [JsonPropertyName("editions")] public List<Edition> Editions { get; set; } = [];

    [JsonPropertyName("elements")] public List<string> Elements { get; set; } = [];

    [JsonPropertyName("effect")] public string? Effect { get; set; }

    [JsonPropertyName("effect_raw")] public string? EffectRaw { get; set; }
    ...
    [JsonPropertyName("legality")] public object? Legality { get; set; }
    ...
    [JsonPropertyName("referenced_by")] public List<object> ReferencedBy { get; set; } = [];

    [JsonPropertyName("references")] public List<object> References { get; set; } = [];

    [JsonPropertyName("result_editions")] public List<Edition> ResultEditions { get; set; } = [];
...
public sealed class Edition
{
    ...
    [JsonPropertyName("collaborators")] public List<object> Collaborators { get; set; } = [];
    ...
    [JsonPropertyName("effect_html")] public string? EffectHtml { get; set; }
    ...
    [JsonPropertyName("set")] public CardSet? Set { get; set; }

    [JsonPropertyName("thema_charm_foil")] public object? ThemaCharmFoil { get; set; }

    [JsonPropertyName("thema_ferocity_foil")]
    public object? ThemaFerocityFoil { get; set; }

    [JsonPropertyName("thema_foil")] public object? ThemaFoil { get; set; }

    [JsonPropertyName("thema_grace_foil")] public object? ThemaGraceFoil { get; set; }

    [JsonPropertyName("thema_mystique_foil")]
    public object? ThemaMystiqueFoil { get; set; }

    [JsonPropertyName("thema_valor_foil")] public object? ThemaValorFoil { get; set; }
    ...
    [JsonPropertyName("thema_nonfoil")] public object? ThemaNonfoil { get; set; }
...
public sealed class CirculationTemplate
{
    ...
    [JsonPropertyName("edition_id")] public string? EditionId { get; set; }

    [JsonPropertyName("foil")] public bool? Foil { get; set; }

    [JsonPropertyName("uuid")] public string? Uuid { get; set; }

    [JsonPropertyName("variants")] public List<object> Variants { get; set; } = [];
